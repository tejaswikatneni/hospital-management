...
RSpec.describe HospitalProfilesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all hospital_profiles as @hospital_profiles" do
      hospital_profile = HospitalProfile.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:hospital_profiles)).to eq([hospital_profile])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created hospital_profile" do
        post :create, {:hospital_profile => valid_attributes}, valid_session
        expect(response).to redirect_to(HospitalProfile.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested hospital_profile" do
        hospital_profile = HospitalProfile.create! valid_attributes
        put :update, {:id => hospital_profile.to_param, :hospital_profile => new_attributes}, valid_session
  ...
  describe "DELETE #destroy" do
    it "destroys the requested hospital_profile" do
      hospital_profile = HospitalProfile.create! valid_attributes
      expect {
        delete :destroy, {:id => hospital_profile.to_param}, valid_session
      }.to change(HospitalProfile, :count).by(-1)
    end

    it "redirects to the hospital_profiles list" do
      hospital_profile = HospitalProfile.create! valid_attributes
      delete :destroy, {:id => hospital_profile.to_param}, valid_session
      expect(response).to redirect_to(hospital_profiles_url)
    end
  end
